...
def srb_blossom(edge_list):
    vertices = srb_input(edge_list)
    global roots
    ...
    srb_M = []
    for e in M:
        a,b = tuple(sorted(v.id for v in e.vertices))
        srb_M.append([a,b,e.value])

    return total_weight,srb_M
